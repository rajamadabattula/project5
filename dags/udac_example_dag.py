...
load_songplays_table = LoadFactOperator(
    ...
    redshift_conn_id='redshift',
    sql_statement=f""" 
        INSERT INTO public.songplays(playid,start_time,userid, level, songid, artistid, sessionid,location,useragent ) 
...
load_user_dimension_table = SubDagOperator(
    subdag=load_dimension_subdag(
        ...
        sql_statement=f""" 
            INSERT INTO public.user (userid,first_name,last_name, gender, level) 
...
load_song_dimension_table = SubDagOperator(
    subdag=load_dimension_subdag(
        ...
        start_date=default_args['start_date'],
        sql_statement=f""" 
            INSERT INTO public.user (song_id, title, artist_id, year, duration) 
...
load_artist_dimension_table = SubDagOperator(
    subdag=load_dimension_subdag(
        ...
        start_date=default_args['start_date'],
        sql_statement=f""" 
            INSERT INTO public.user (artist_id, artist_name, artist_location, artist_latitude, artist_longitude) 
...
load_time_dimension_table = SubDagOperator(
    subdag=load_dimension_subdag(
        ...
        start_date=default_args['start_date'],
        sql_statement=f""" 
            INSERT INTO public.user (start_time,hour,day, week, month,year, weekday) 
